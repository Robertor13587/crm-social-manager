  ...
  <div class="space-y-6">
    ...
    <div class="card">
      <div class="flex items-start gap-3">
        ...
        <div class="min-w-0">
          <h3 class="text-sm font-semibold text-slate-900">Comunicazione Meta — Revisione Facebook in corso</h3>
          <div class="mt-2 text-sm text-slate-700 space-y-2">
            <p>L'app è in revisione per le autorizzazioni Facebook (Page Messaging e lettura engagement). Alcune funzioni sono limitate finché l'approvazione non è completata.</p>
            <ul class="list-disc list-inside">
              <li>DM consultabili dai thread esistenti; l'invio potrebbe essere differito finché l'app non è approvata.</li>
              <li>Statistiche e follower sono mostrati dal database locale e saranno riallineati dopo l'approvazione.</li>
              <li>I webhook pagina restano attivi; la consegna eventi può essere parziale durante la revisione.</li>
            </ul>
            <p class="font-semibold text-slate-900">Prossimi passi</p>
            <ul class="list-disc list-inside">
              <li>Completa App Review, abilita le sottoscrizioni agli eventi pagina e verifica la firma di sicurezza.</li>
              <li>Allega uno screencast che mostri i flussi di messaggistica e la gestione dei dati.</li>
              <li>Verifica conformità alle policy e ripresenta in caso di richieste aggiuntive.</li>
            </ul>
            <p>Tempi medi di approvazione: 1–3 giorni lavorativi. Notifica inviata all'email proprietaria dell'app.</p>
          </div>
        </div>
      </div>
    </div>
